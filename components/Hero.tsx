...
export default function Hero() {
  // FIXED: Destructure language here
  ...
  return (
    <section className="relative min-h-screen lg:min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-linear-to-br from-macord-dark via-macord-dark/85 to-black/60 z-1" />
        <img 
          src="/macord.jpg" 
        ...
        <div className="absolute inset-0 bg-linear-to-r from-macord-dark via-macord-dark/70 to-transparent z-2" />
        <div className="absolute inset-0 bg-linear-to-t from-macord-dark/30 via-transparent to-transparent z-2" />
      </div>
      ...
      <div className={`relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20 lg:py-0 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-4xl space-y-8 lg:space-y-10">
          ...
          <div className="space-y-5 lg:space-y-6">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white leading-[1.1] lg:leading-[1.1]">
              <span className="block">
                ...
                {language === 'en' ? 'Nurturing' : 'Cultiver'}
              </span>
              <span className="block mt-2 text-transparent bg-clip-text bg-linear-to-r from-macord-cyan via-white to-macord-primary">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            >
              <span className="absolute inset-0 bg-linear-to-r from-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-500" />
          ...
          <div className="flex flex-wrap gap-6 pt-8 border-t border-white/10">
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/80 text-sm">
                {language === 'en' ? 'French & British' : 'Français & Britannique'}
              </span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-macord-cyan/10 flex items-center justify-center">
              ...
              <span className="text-white/80 text-sm">
                {language === 'en' ? 'Cambridge Certified' : 'Certifié Cambridge'}
              </span>
            </div>
          </div>
        </div>
